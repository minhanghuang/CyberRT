...
static void InitDefaultsscc_info_Clock_clock_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Clock_clock_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Clock_clock_2eproto}, {}};
...
const char descriptor_table_protodef_clock_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_clock_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_clock_2eproto_sccs[1] = {
  &scc_info_Clock_clock_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_clock_2eproto = {
  false, false, descriptor_table_protodef_clock_2eproto, "clock.proto", 57,
  &descriptor_table_clock_2eproto_once, descriptor_table_clock_2eproto_sccs, descriptor_table_clock_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_clock_2eproto::offsets,
  file_level_metadata_clock_2eproto, 1, file_level_enum_descriptors_clock_2eproto, file_level_service_descriptors_clock_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_clock_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_clock_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
...
const Clock& Clock::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Clock_clock_2eproto.base);
