...
class UnitTestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<UnitTest> _instance;
...
class ChatterBenchmarkDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ChatterBenchmark> _instance;
} _ChatterBenchmark_default_instance_;
}  // namespace proto
}  // namespace cyber
}  // namespace apollo
static void InitDefaultsscc_info_Chatter_unit_5ftest_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Chatter_unit_5ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Chatter_unit_5ftest_2eproto}, {}};

static void InitDefaultsscc_info_ChatterBenchmark_unit_5ftest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChatterBenchmark_unit_5ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChatterBenchmark_unit_5ftest_2eproto}, {}};

static void InitDefaultsscc_info_UnitTest_unit_5ftest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_UnitTest_unit_5ftest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_UnitTest_unit_5ftest_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_unit_5ftest_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_unit_5ftest_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_unit_5ftest_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_unit_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_unit_5ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_unit_5ftest_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_unit_5ftest_2eproto_sccs[3] = {
  &scc_info_Chatter_unit_5ftest_2eproto.base,
  &scc_info_ChatterBenchmark_unit_5ftest_2eproto.base,
  &scc_info_UnitTest_unit_5ftest_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_unit_5ftest_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_unit_5ftest_2eproto = {
  false, false, descriptor_table_protodef_unit_5ftest_2eproto, "unit_test.proto", 238,
  &descriptor_table_unit_5ftest_2eproto_once, descriptor_table_unit_5ftest_2eproto_sccs, descriptor_table_unit_5ftest_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_unit_5ftest_2eproto::offsets,
  file_level_metadata_unit_5ftest_2eproto, 3, file_level_enum_descriptors_unit_5ftest_2eproto, file_level_service_descriptors_unit_5ftest_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_unit_5ftest_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_unit_5ftest_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
...
void UnitTest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_UnitTest_unit_5ftest_2eproto.base);
  class_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  case_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void UnitTest::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:apollo.cyber.proto.UnitTest)
  GOOGLE_DCHECK_NE(&from, this);
  const UnitTest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<UnitTest>(
          &from);
  if (source == nullptr) {
...
void UnitTest::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
void Chatter::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Chatter_unit_5ftest_2eproto.base);
  content_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void ChatterBenchmark::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ChatterBenchmark_unit_5ftest_2eproto.base);
  content_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
...
void ChatterBenchmark::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:apollo.cyber.proto.ChatterBenchmark)
  GOOGLE_DCHECK_NE(&from, this);
  const ChatterBenchmark* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ChatterBenchmark>(
          &from);
  if (source == nullptr) {
...
void ChatterBenchmark::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
