...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_role_5fattributes_2eproto = {
  false, false, descriptor_table_protodef_role_5fattributes_2eproto, "role_attributes.proto", 457,
...
static bool dynamic_init_dummy_role_5fattributes_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_role_5fattributes_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
