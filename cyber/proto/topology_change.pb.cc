...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_ChangeMsg_topology_5fchange_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_ChangeMsg_topology_5fchange_2eproto}, {
...
const char descriptor_table_protodef_topology_5fchange_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_topology_5fchange_2eproto = {
  false, false, descriptor_table_protodef_topology_5fchange_2eproto, "topology_change.proto", 567,
...
static bool dynamic_init_dummy_topology_5fchange_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_topology_5fchange_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
