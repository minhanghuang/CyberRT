...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ProtoDesc_proto_5fdesc_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ProtoDesc_proto_5fdesc_2eproto}, {}};
...
const char descriptor_table_protodef_proto_5fdesc_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_5fdesc_2eproto = {
  false, false, descriptor_table_protodef_proto_5fdesc_2eproto, "proto_desc.proto", 118,
...
static bool dynamic_init_dummy_proto_5fdesc_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_5fdesc_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
