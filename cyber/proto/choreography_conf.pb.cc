...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_choreography_5fconf_2eproto = {
  false, false, descriptor_table_protodef_choreography_5fconf_2eproto, "choreography_conf.proto", 493,
...
static bool dynamic_init_dummy_choreography_5fconf_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_choreography_5fconf_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
