...
static void InitDefaultsscc_info_QosProfile_qos_5fprofile_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_QosProfile_qos_5fprofile_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_QosProfile_qos_5fprofile_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_qos_5fprofile_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_qos_5fprofile_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_qos_5fprofile_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_qos_5fprofile_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_qos_5fprofile_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "LE\020\002"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_qos_5fprofile_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_qos_5fprofile_2eproto_sccs[1] = {
  &scc_info_QosProfile_qos_5fprofile_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_qos_5fprofile_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_qos_5fprofile_2eproto = {
  false, false, descriptor_table_protodef_qos_5fprofile_2eproto, "qos_profile.proto", 644,
  &descriptor_table_qos_5fprofile_2eproto_once, descriptor_table_qos_5fprofile_2eproto_sccs, descriptor_table_qos_5fprofile_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_qos_5fprofile_2eproto::offsets,
  file_level_metadata_qos_5fprofile_2eproto, 1, file_level_enum_descriptors_qos_5fprofile_2eproto, file_level_service_descriptors_qos_5fprofile_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_qos_5fprofile_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_qos_5fprofile_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* QosHistoryPolicy_descriptor() {
  ...
  return file_level_enum_descriptors_qos_5fprofile_2eproto[0];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* QosReliabilityPolicy_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_qos_5fprofile_2eproto);
  return file_level_enum_descriptors_qos_5fprofile_2eproto[1];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* QosDurabilityPolicy_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_qos_5fprofile_2eproto);
  return file_level_enum_descriptors_qos_5fprofile_2eproto[2];
}
...
const QosProfile& QosProfile::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_QosProfile_qos_5fprofile_2eproto.base);
