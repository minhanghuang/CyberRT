...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<4> scc_info_CyberConfig_cyber_5fconf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 4, 0, InitDefaultsscc_info_CyberConfig_cyber_5fconf_2eproto}, {
...
const char descriptor_table_protodef_cyber_5fconf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_5fconf_2eproto = {
  false, false, descriptor_table_protodef_cyber_5fconf_2eproto, "cyber_conf.proto", 359,
...
static bool dynamic_init_dummy_cyber_5fconf_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_cyber_5fconf_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
